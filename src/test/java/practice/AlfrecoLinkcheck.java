...
else if (hrefs==null || hrefs.isEmpty()) {
	System.out.println("there is valid url under href or src");
...
finalReplacedList.add(url.replace("http://sharepv", "https://sharepv"));
