...
public class LinkNavigationEAGLEPageDV {
...
for (String url : resList) {
			...
			if(url.contains("http://intranetdv."))
			{
				toBeReplaceDV++;
			}
			...
			else if(url.contains("http://intranet.")||url.contains("https://intranet."))
			{
				toBeReplacehttp++;
			}

			finalReplacedList.add(url.replace("https://intranet.","https://intranetdv."));
	
			finalReplacedList.add(url.replace( "https://intranetqa.","https://intranetdv."));
