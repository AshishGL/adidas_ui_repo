...
public class LinkNavigationWhyGartnerPageDV {
	...
	public static void main(String[] args) throws Exception {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\ankrana\\Downloads\\chromedriver.exe");
			...
			driver.get("https://intranetdv.gartner.com/our-story/why-gartner");
...
System.out.println("*****************list contains all url under http://intranet and https://intranetdv.*******************************************************************");
